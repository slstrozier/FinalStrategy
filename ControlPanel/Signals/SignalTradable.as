package ControlPanel.Signals{
	...
	public class SignalTradable extends MovieClip{
		...
		public function SignalTradable(isComparedEntity:Boolean) {
		...
		function createSummery():String{
			...
			summery =  _HumanTradableEntity + _HumanDatabase + " with " + _HumanTreatment;
			}
			return summery;
		}
		...
		*/
		...
		parameterDescriptions:Array, object:Object, parameterString:String, defaults:Array = null):void
		{
			...
			{
				for (var m:int = 0; m < fieldArray.length; m++)
				{
					removeChild(fieldArray[m]);
				}
			}
