package ControlPanel.StrategyTester.TradeEntities{
	...
	public class TradeIndicator extends MovieClip{
		...
		public function TradeIndicator(isComparedEntity:Boolean) {
		...
		function createSummery():String{
		    ...
		    var summery:String =  _HumanIndicator + " on " + _HumanDatabase + " with " + _HumanTreatment// + " is " + _HumanMathOperator;
